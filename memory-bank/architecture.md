...
������ src/
    ...
    ������ types/index.ts          # ������ REST + WS ��Լ�����Ͷ���
    ������ router/index.ts         # ·�� + ��Ȩ���� (guest ҳ vs ��¼ҳ)
    ������ stores/
    ��   ������ auth.ts             # token/user �־û�(localStorage) + login/register/logout
    ��   ������ player.ts           # profile/warehouse/characters/myCards
    ��   ������ game.ts             # WS ���� + ��ս״̬��(���/����/����/�غ�/ʤ��)
    ������ services/
    ��   ������ http.ts             # axios ʵ�� + JWT ������ + 401 �ǳ� + typed helpers
    ��   ������ api.ts              # ȫ�� REST ���� (authApi/playerApi/gatheringApi/...)
...
| �� | ѡ�� |
|----|------|
| API �� | axios ������ͳһ�� JWT + 401 �Զ��ǳ�����¼ + ���� `{success,data}` �ŷ⣻`httpGet/Post/Put/Delete` typed helpers ֱ�ӷ����ŷ����� |
| WS | socket.io `io('/', {auth:{token}})` Ĭ�������ռ䣻������ JWT ��Ȩ��`connect_error` ������Ȩʧ�� |
| ��ս״̬ | game store ���й��� board/ownHand/�غ�/ʤ�����¼��������£�`isMyTurn` ��������/���ò��� |
| ·������ | δ��¼ �� /login��guest ҳ(login/register)�ѵ�¼ �� /home |
| �������� | vite proxy: /api + /socket.io �� localhost:3000 (�� CORS) |

### ״̬
- T057 ���: ��Ŀ�� `npm run build` (vue-tsc + vite) ͨ��
- T058(·��) / T059(Pinia) / T060-T063(��¼ע��/��ҳ+��������) ��Ǽܾ���
- T064+ (����/�ֿ�/����/����/ս��/ƥ��/�������) ������
- ǰ�������йܷ���δ�� (Caddy ��̬�й� / �������� / ����ͬ��)
