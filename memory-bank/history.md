...
## 2026-08-06 - ����T-FIX �����޸����Σ�P0 �� bug �޸���

### Prompt
���ļ�������Ҫ������������������������Ŀ�Ƿ���Ҫ�޸ģ�Ȼ������޸ġ�

### ˼��
���ŷ���"����ȫ�̵������ܲ�ͨ"����Ԫ����ȫ�� mock �� DB/Redis���ڸ��� 8 ������ bug�������Ǽܹ����ѽڡ���ս��״̬��д Redis���������� DB��˫״̬Դ���������ƶ�/����/�غ��ƽ�������ȫ��ʧ�ܡ��޸����ԣ�
1. ���� `getSessionState`���� Redis ����״̬�� activationOrder����ս����·ͳһ������DB �����
2. `executePlayCard` ���ٶ��� completePlayPhase��ͳһ���� `executeEndStep`���޸�˫���ƽ���
3. ���� STRING �洢���� `removeCardFromHand`����-����-����д������������ lRem
4. ��Ӫ�ж��� battles �� player1/2_id (UUID) ӳ�� side���ݵ����갴 positions HASH ����
5. ����ϵͳ������/�ɼ�/����/�ӹ���ȫ���� withTransaction + SELECT FOR UPDATE ����

### ����
1. PowerShell Set-Content �ƻ������ļ� UTF-8 ���루����ע������ TS �������󣩣����� edit ���� + git checkout �ָ�
2. �ɲ��Զ����˴����ʵ����Ϊ���� "executeRoundEnd ʧ��ʱ end_step δ��"������ͬ����������ƥ����ȷ�߼�
3. test mock �������� `mockGetDbSessionState`���ĺ�������ȫ���滻�����ֲ���ȱ activationOrder �ֶ�
4. lint �� 63 ������ error����Ϊ test �ļ� require ��񣩣��Ǳ������룬δ����

### �޸�
- �������� 15 �ļ���battleActionService / battleSessionService / battleService / battleOutcomeService / battleRoom / craftingService / gatheringService / playerService / player.ts / processing.ts / characters.ts / jwt.ts / index.ts / auth.ts / authMiddleware.ts
- ���� 6 �ļ�ͬ������ + deploy.sh �ع������޸�
- ���Ի��ߣ�ȫ�� 671/702 ͨ����4 suite ʧ�ܾ�Ϊ������ PG/Redis�������һ�£���tsc �������� 28 suite 566 ����ȫ��

### ��Χ��
- T-FOLLOW-7 v0.1.1 ����ʧ������ SSH ���ԣ�P1��
- ʣ�� P1/P2 �������ͳһ�����湤�߳�ȡ��Redis key �������С�Ǩ�� 004 ȱʧ��CORS ������

---

## 2026-08-06 - ����T-FIX ���� 2��P1/P2 ����/�ʲ���ȫ + �������ࣩ

### Prompt
��������ʣ�๤����

### ˼��
������ 1��P0 ս�������޸���֮�󣬴���ʣ�� P1������/�ʲ���ȫ���� P2���������ࣩ�
- P1-A: moveCharacter ���η�ԭ�ӣ�hGet+hDel+hSet����Ϊ Lua �ű�ԭ��ִ�У��ž������Ӳ�����ռͬһ�ո�
- P1-B: settleBattle �ݵ� read-then-write ��̬ �� ������ SELECT ... FOR UPDATE �������� settled_at
- P1-C: consumePlayerCard ֱ�� DELETE �޹������� �� DELETE �� character_id + �Ӳ�ѯ���� card ����
- P1-D: ��ȫ�ִ����м�� �� �� 4 �� Express error handler��ͳһ JSON ��ʽ
- P1-E: CORS ȫ�� + auth ������ �� CORS_ORIGIN env ���� + Redis Lua �����м��
- P2-A: 5 ����д 5 ���ӻ��� �� createCache ��������
- P2-B: Redis key 4 ����д �� redisKey ����ģ��
- P2-C: controller �� `.includes('����')` ƥ����� �� MatchmakingError/GatheringError ������
- P2-D: Ǩ��ȱ 004 + ���� ON CONFLICT ʧЧ �� 004 ��ΨһԼ�� + 005 �� ON CONFLICT(name)

### ����
1. battleSettlementService ���伯�ɲ��Ե� withTransaction mock �ͻ��� query ��Ĭ��ʵ�֣�����������ѯ�� `lockRes.rows` ���� �� ���� beforeEach �� `mockClientQuery.mockResolvedValue({ rows: [{ settled_at: null }] })`
2. migrate.test.ts 3 ��ʧ���� Windows ·���ָ�����D:\ vs /���������⣬�Ǳ������루CI Linux ͨ����
3. ����̨��� UTF-8 �������룬���ض����ļ����� Read ���
4. rateLimit Lua ���������ں�����ģ������� const ��ʼ������������������ʱ������ TDZ ���⣩

### �޸�
- �������� 12 �ļ���battleService / battleSettlementService / battleActionService / matchmakingService / gatheringService / handService / battleOutcomeService / battleSessionService / battleInitializationService / statusEffectService / professionMechanicService / index.ts / player.ts / processing.ts / characters.ts / craftingService / processingService / cardService / skillService / professionService / matchmakingController / gatheringController / auth.ts
- ���� 4 �ļ���utils/cache.ts / utils/redisKeys.ts / middleware/rateLimit.ts / migrations/004_t_fix_card_template_unique.sql
- ���� 3 �ļ����� + migrate 004 Ǩ���ļ�
- ���Ի��ߣ�ȫ�� 671/702 ͨ����4 suite ʧ�� = Windows ·�� + ������ PG/Redis�������һ�£���tsc ����󣻸Ķ��ļ��� lint error

### ��Χ��
- migrate.test.ts �� Windows ·�������޸���CI Linux ���裩
- T-FOLLOW-7 v0.1.1 ����ʧ���Դ� SSH ���ԣ����û� VPS ���ʣ�
- ʣ�� P2��REST ���ͳһ�����ʻ� URL vs ��Դ��������ɫ��/�û�������У�顢authService ע�����񻯡���Ӧ������ʽͳһ
